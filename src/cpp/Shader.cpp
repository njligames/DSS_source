...
namespace NJLIC {
    ...
    // bool Shader::compileShader(GLuint &shader, GLenum type, const std::string
    // &source)
    //{
    //    GLint status;
    ...
    //    if (!_source)
    //    {
    //        SDL_LogError(SDL_LOG_CATEGORY_APPLICATION, "Failed to load vertex
    //        shader"); return false;
    //    }
    //
    //    shader = glCreateShader(type);
    ...
    //            glGetShaderInfoLog(shader, logLength, &logLength, log);
    //
    //            SDL_LogError(SDL_LOG_CATEGORY_APPLICATION, "Shader compile
    //            log:\n%s", log); free(log);
    //        }
    //
    //        return false;
    ...
    //        {
    //            GLchar *log = (GLchar *)malloc(logLength);
    //            glGetProgramInfoLog(programPointer, logLength, &logLength,
    //            log);
    //
    //            SDL_LogError(SDL_LOG_CATEGORY_APPLICATION, "Program link
    //            log:\n%s", log); free(log);
    //        }
    //
    //        return false;
    ...
    //            log);
    //
    //            SDL_LogError(SDL_LOG_CATEGORY_APPLICATION, "Program validate
    //            log:\n%s", log); free(log);
    //        }
    //        return false;
    //    }
    ...
    //    {
    //        SDL_LogError(SDL_LOG_CATEGORY_APPLICATION, "Failed to link
    //        program: %d", programPointer);
    //
    //        if (vertexShader) {
    ...
    ////    GLint videoFrame = glGetUniformLocation(programPointer,
    ///"videoFrame"); /    uniforms[UNIFORM_VIDEOFRAME] = videoFrame; /
    /// uniforms[UNIFORM_INPUTCOLOR] = glGetUniformLocation(programPointer,
    ///"inputColor"); /    uniforms[UNIFORM_THRESHOLD] =
    /// glGetUniformLocation(programPointer, "threshold");
    //
