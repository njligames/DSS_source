...
void TestClass::input() {
    ...
    SDL_PumpEvents();
        while (SDL_PollEvent(&event)) {
                            ...
                            case SDLK_c:
                                    ...
                                    if (withAlt) {
                                        ...
                                        int w, h;
                                            if (mRenderer) {
                                                SDL_Rect clip;
                                                SDL_GetWindowSize(mWindow, &w,
                                                                  &h);
                                                SDL_RenderGetClipRect(mRenderer,
                                                                      &clip);
                                        ...
                                        SDL_Window *current_win =
                                            ...
                                            if (current_win) {
                                                const bool shouldCapture =
                                                    ...
                                                    0;
                                                const int rc = SDL_CaptureMouse(
                                                    (SDL_bool)shouldCapture);
                                                SDL_Log(
                                                    "%sapturing mouse %s!\n",
                                                    shouldCapture ? "C" : "Unc",
                                                    (rc == 0) ? "succeeded"
                ...
                case SDL_MOUSEWHEEL:
                    SDL_Log(
                        "SDL EVENT: Mouse: wheel scrolled %d in x and %d in y "
